...
![](/2019-11-20-the-trouble-with-vpn-and-privacy-review-sites/image1.png "Affiliate links and discounts galore! This is a different site than before, but look at the familiar faces we’re seeing…")
...
Finally, when you’re choosing a VPN provider, do your own research.  [Understand what a VPN actually does for you]({{< ref "understanding-vpns.md" >}}).  [Understand what it is a security audit proves](https://www.pcmag.com/article/371839/what-does-a-vpn-security-audit-really-prove), find out who owns and operates the VPN service you want to use, and make sure their policies and technologies reflect your values.  [Ultimately gathering the information yourself]({{< ref "choosing-a-vpn.md" >}}) and making an informed decision is the only way to make sure your privacy is being respected.
